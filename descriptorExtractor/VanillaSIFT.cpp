...
// determines the size of a single descriptorExtractor orientation histogram
const float VanillaSIFT::SIFT_DESCR_SCL_FCTR = 3.f;

// threshold on magnitude of elements of descriptorExtractor printf
const float VanillaSIFT::SIFT_DESCR_MAG_THR = 0.2f;

// factor used to convert floating-point descriptorExtractor to unsigned char
